...
class SubtraiDatas extends OperacaoBinaria {
    getTime(data) {
...
const meuniver = new classes_1.Data(13, 7, 2025);
const hoje = new classes_1.Data(14, 7, 2025);
